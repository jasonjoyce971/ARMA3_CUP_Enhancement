private ["_logic","_units","_activated","_hp1","_hp2","_hp3","_hp4","_hp5","_hp6","_hp7","_hp8","_hp9","_hp10"];
...
if (_activated) then {
		...
		{
			_plane = vehicle _x;
			if (_plane iskindof "JAS_CUP_B_F35B_RAF") then
			{
				[_plane,_hp1,_hp2,_hp3,_hp4,_hp5,_hp6,_hp7,_hp8,_hp9,_hp10] spawn JAS_fnc_f35RAF_loadout_set;
			}
			else 
			{
				hint "module is must sync with F-35!";
			};
		} foreach _units;
