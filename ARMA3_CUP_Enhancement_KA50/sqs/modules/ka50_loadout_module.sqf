private ["_logic","_units","_activated","_hp1","_hp2","_hp3","_hp4","_skin"];
...
if (_activated) then {
		...
		
		{
			...
			{
				[_plane,_hp1,_hp2,_hp3,_hp4,_skin] spawn JAS_fnc_ka50_loadout_set;
			}
			else 
			{
				hint "module is must sync with Ka-50!";
			};
		} foreach _units;
