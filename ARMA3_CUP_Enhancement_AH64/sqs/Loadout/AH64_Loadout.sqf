...
sleep 0.3;
	...
	Switch (_hardpoint4) Do
	{
		...
		case 7:
		{
			_plane setPylonLoadOut ["pylonLeft1", "JAS_FIR_Hellfire_K_1rnd_PYLON_M", true, [0]];
			//_plane addmagazine "JAS_CUP_1Rnd_AGM_Rack_M"; // Hellfire K
		};
		case 8:
		{
...
sleep 0.3;
	...
	Switch (_hardpoint5) Do
	{
		...
		case 7:
		{
			_plane setPylonLoadOut ["pylonRight1", "JAS_FIR_Hellfire_K_1rnd_PYLON_M", true, [0]];
			//_plane addmagazine "JAS_CUP_1Rnd_AGM_Rack_M"; // Hellfire K
		};
		case 8:
		{
...
sleep 0.3;
	...
	Switch (_hardpoint6) Do
	{
		...
		case 7:
		{
			_plane setPylonLoadOut ["pylonLeft2", "JAS_FIR_Hellfire_K_1rnd_PYLON_M", true, [0]];
			//_plane addmagazine "JAS_CUP_1Rnd_AGM_Rack_M"; // Hellfire K
		};
		case 8:
		{
	...
	Switch (_preset) do
	{
		...
		case 1:
		{
			...
			else
			{
				...
				_loadcustom1 = ["custom1"]execVM "ARMA3_CUP_Enhancement_AH64\sqs\Loadout\AH64_Custom_Apply.sqf";
			};		
		};
		...
		case 2:
		{
			...
			{
				titleText ["found custom loadout data. loading..", "PLAIN DOWN",0.5];
				_loadcustom1 = ["custom2"]execVM "ARMA3_CUP_Enhancement_AH64\sqs\Loadout\AH64_Custom_Apply.sqf";
			};			
		};
		...
		case 3:
		{
			...
			{
				titleText ["found custom loadout data. loading..", "PLAIN DOWN",0.5];
				_loadcustom1 = ["custom3"]execVM "ARMA3_CUP_Enhancement_AH64\sqs\Loadout\AH64_Custom_Apply.sqf";
			};	
		};
	};
};
