...
class CfgVehicles
{
	...
	class JAS_CUP_AW159_Unarmed_Base : Helicopter_Base_H
	{
		...
		scopeCurator = 0;
		faction = "Blu_F";
		author = "DeltaGamer/CUP/-{GOL}-Jason";
	...
	class JAS_CUP_B_AW159_Unarmed_GB : JAS_CUP_AW159_Unarmed_Base
	{
		...
		class eventhandlers
		{
			Init = "AP_CUSTOM_RAPPEL_POINTS = [['JAS_CUP_B_AW159_Unarmed_GB',[[1.15,1.0,1.25],[-1.15,1.0,1.25]]]];";
		};
	};
	...
	class JAS_CUP_B_Wildcat_Unarmed_RN_Grey : JAS_CUP_B_AW159_Unarmed_GB
	{
		...
		class eventhandlers
		{
			Init = "AP_CUSTOM_RAPPEL_POINTS = [['JAS_CUP_B_Wildcat_Unarmed_RN_Grey',[[1.15,1.0,1.25],[-1.15,1.0,1.25]]]];";
		};
	};
	...
	class JAS_CUP_B_Wildcat_Unarmed_Digital_AAF : JAS_CUP_AW159_Unarmed_Base
	{
		...
		class eventhandlers
		{
			Init = "AP_CUSTOM_RAPPEL_POINTS = [['JAS_CUP_B_Wildcat_Unarmed_Digital_AAF',[[1.15,1.0,1.25],[-1.15,1.0,1.25]]]];";
		};
	};
	...
	class JAS_CUP_B_AW159_Unarmed_AACX : JAS_CUP_AW159_Unarmed_Base
	{
		...
		class eventhandlers
		{
			...
			Init = "[_this,JAS_CUP_B_AW159_Unarmed_AACX] call JAS_fnc_ROPE_INIT;AP_CUSTOM_RAPPEL_POINTS = [['JAS_CUP_B_AW159_Unarmed_AACX',[[1.15,1.0,1.25],[-1.15,1.0,1.25]]]];";
		};
	};
