...
switch (_customslot) do
{
	case "custom_1":
	{
		profileNamespace setVariable ["Y32_Custom_slot1",[_hardpoint1,_hardpoint2,_hardpoint3,_hardpoint4]];
		titleText ["Custom Payload Saved to Slot 1", "PLAIN DOWN",0.5];
	};
	case "custom_2":
	{
		profileNamespace setVariable ["Y32_Custom_slot2",[_hardpoint1,_hardpoint2,_hardpoint3,_hardpoint4]];
		titleText ["Custom Payload Saved to Slot 2", "PLAIN DOWN",0.5];
	};
	case "custom_3":
	{
		profileNamespace setVariable ["Y32_Custom_slot3",[_hardpoint1,_hardpoint2,_hardpoint3,_hardpoint4]];
