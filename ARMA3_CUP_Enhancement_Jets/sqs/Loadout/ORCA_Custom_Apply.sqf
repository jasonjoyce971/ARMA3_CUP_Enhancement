...
switch (_customslot) do
{
	case "custom1":
	{
		_array = profileNamespace getVariable "ORCA_Custom_slot1";
	};
	case "custom2":
	{
		_array = profileNamespace getVariable "ORCA_Custom_slot2";
		};
	case "custom3":
	{
		_array = profileNamespace getVariable "ORCA_Custom_slot3";
	};
};
...
sleep 0.01;
	...
	Switch (_hardpoint1) Do
	{
		...
		case 6:
		{
			_plane setPylonLoadOut ["PylonRight1", "PylonWeapon_2000Rnd_65x39_belt", true, [0]];
		};
		case 7:
		{
