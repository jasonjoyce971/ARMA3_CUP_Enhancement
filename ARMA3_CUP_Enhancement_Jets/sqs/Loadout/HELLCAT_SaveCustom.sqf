...
switch (_customslot) do
{
	case "custom_1":
	{
		profileNamespace setVariable ["HELLCAT_Custom_slot1",[_hardpoint1,_hardpoint2]];
		titleText ["Custom Slot 1 is Saved", "PLAIN DOWN",0.5];
	};
	case "custom_2":
	{
		profileNamespace setVariable ["HELLCAT_Custom_slot2",[_hardpoint1,_hardpoint2]];
		titleText ["Custom Slot 2 is Saved", "PLAIN DOWN",0.5];
	};
	case "custom_3":
	{
		profileNamespace setVariable ["HELLCAT_Custom_slot3",[_hardpoint1,_hardpoint2]];
