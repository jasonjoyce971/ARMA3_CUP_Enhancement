...
sleep 0.01;
	...
	Switch (_hardpoint1) Do // Right Outboard
	{
		...
		case 4:
		{
			_plane setPylonLoadOut ["pylonRight1", "PylonRack_20Rnd_Rocket_03_HE_F", true, [0]];
		};
		case 5:
		{
			_plane setPylonLoadOut ["pylonRight1", "PylonRack_20Rnd_Rocket_03_AP_F", true, [0]];
		};
		case 6:
		{
		...
		case 8:
		{
			_plane setPylonLoadOut ["pylonRight1", "JAS_PylonWeapon_300Rnd_20mm_shells", true, [0]];
		};
		case 9:
		{
...
sleep 0.3;
	...
	Switch (_hardpoint2) Do // Left Outboard
	{
		...
		case 4:
		{
			_plane setPylonLoadOut ["pylonLeft1", "PylonRack_20Rnd_Rocket_03_HE_F", true, [0]];
		};
		case 5:
		{
			_plane setPylonLoadOut ["pylonLeft1", "PylonRack_20Rnd_Rocket_03_AP_F", true, [0]];
		};
		case 6:
		{
		...
		case 8:
		{
			_plane setPylonLoadOut ["pylonLeft1", "JAS_PylonWeapon_300Rnd_20mm_shells", true, [0]];
		};
		case 9:
		{
...
sleep 0.3;
	...
	Switch (_hardpoint3) Do // Right Midline
	{
		...
		case 4:
		{
			_plane setPylonLoadOut ["pylonRight2", "PylonRack_20Rnd_Rocket_03_HE_F", true, [0]];
		};
		case 5:
		{
			_plane setPylonLoadOut ["pylonRight2", "PylonRack_20Rnd_Rocket_03_AP_F", true, [0]];
		};
		case 6:
		{
		...
		case 8:
		{
			_plane setPylonLoadOut ["pylonRight2", "JAS_PylonWeapon_300Rnd_20mm_shells", true, [0]];
		};
		case 9:
		{
...
sleep 0.3;
	...
	Switch (_hardpoint4) Do // Left Midline
	{
		...
		case 4:
		{
			_plane setPylonLoadOut ["pylonLeft2", "PylonRack_20Rnd_Rocket_03_HE_F", true, [0]];
		};
		case 5:
		{
			_plane setPylonLoadOut ["pylonLeft2", "PylonRack_20Rnd_Rocket_03_AP_F", true, [0]];
		};
		case 6:
		{
		...
		case 8:
		{
			_plane setPylonLoadOut ["pylonLeft2", "JAS_PylonWeapon_300Rnd_20mm_shells", true, [0]];
		};
		case 9:
		{
