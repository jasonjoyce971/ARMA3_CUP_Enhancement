...
if (_activated) then {
		...
		
		{
			...
			{
				[_plane,_hp1,_hp2,_hp3,_hp4,_hp5,_hp6,_hp7,_hp8,_hp9,_hp10,_hp11,_hp12,_skin] spawn JAS_fnc_su34_loadout_set;
			}
			else 
			{
				hint "module is must sync with Su-34!";
			};
		} foreach _units;
