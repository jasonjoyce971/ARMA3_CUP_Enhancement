...
_plane removeMagazines "FIR_Hydra_Smoke_7rnd_M";
_plane removeMagazines "FIR_Hydra_Smoke_Red_7rnd_M";
_plane removeMagazines "FIR_Hydra_Smoke_Orange_7rnd_M";
_plane removeMagazines "FIR_Hydra_Smoke_Purple_7rnd_M";
...
_plane removeMagazines "CUP_1Rnd_MK82_Rack_M";
...
_mk84gpcount = {_x == "FIR_mk84_gp_1rnd_M"} count magazines _plane;
...
if (_mk84gpcount >= 1) then {_plane addweapon "FIR_mk84";};
...
if (_hydraSMKWcount >= 1) then 
{
	...
	{
		_counter = _counter + 1;
		_plane addmagazine "FIR_Hydra_Smoke_7rnd_M";
	};
};
if (_hydraSMKRcount >= 1) then 
{
	...
	{
		_counter = _counter + 1;
		_plane addmagazine "FIR_Hydra_Smoke_Red_7rnd_M";
	};
};
if (_hydraSMKOcount >= 1) then 
{
	...
	while {_counter7 <= _hydraSMKOcount} do
	{
		...
		_plane addmagazine "FIR_Hydra_Smoke_Orange_7rnd_M";
	};
};
if (_hydraSMKPcount >= 1) then
{
	...
	while {_counter19 <= _hydraSMKPcount} do
	{
		...
		_plane addmagazine "FIR_Hydra_Smoke_Purple_7rnd_M";
	};
};
if (_SUUcount >= 1) then 
{
