...
switch (_customslot) do
{
	case "custom1":
	{
		_array = profileNamespace getVariable "Mi17_Custom_slot1";
	};
	case "custom2":
	{
		_array = profileNamespace getVariable "Mi17_Custom_slot2";
		};
	case "custom3":
	{
		_array = profileNamespace getVariable "Mi17_Custom_slot3";
	};
};
