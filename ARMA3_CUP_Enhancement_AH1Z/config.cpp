...
{ 
	...
	{ 
		...
		icon = "ARMA3_CUP_Enhancement_AH1Z\presentation\flag.paa"; // Path to texture next to the faction name in editor - may be 2D editor only
...
class CfgHints
{
	class AWSAIRCRAFT
	{
		...
		class AH1Z
		{
			...
			arguments[] = {};
			// Optional image
			image = "\ARMA3_CUP_Enhancement_AH1Z\presentation\picture.paa";
...
class AH1_GUI
{
	...
	class Controls
	{
		...
		{
			idc=1610;
			text="ARMA3_CUP_Enhancement_AH1Z\ui\button_skin.paa";
		...
		class AH1_Skin_Button2: RscButton
		{
			...
			action="_skinhandle = execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\setskin\setskin_open.sqf""";
		};
		class rsc1 : RscText
		{
			idc = 1000;
		...
		class btn_refuel : RscButton
		{
			...
			action = "_applyhandle = execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\loadout\A164_Refuel.sqf""";
		};
		...
		class btn_repair : RscButton
		{
			...
			action = "_applyhandle = execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\loadout\A164_Repair.sqf""";
		};
...
class AAC_Texture_GUI
{
	...
	class controls
	{
		...
		class texture_combo: RscCombo
		{
			...
			w="0.0875 * safezoneW";
			h="0.028 * safezoneH";
			onLBSelChanged="_changehandle = execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\setskin\change_preview.sqf"";";
		};
		...
		class apply_btn: RscButton
		{
			...
			colorBackground[]={-1,-1,-1,-1};
			colorActive[]={-1,-1,-1,-1};
			action="_applyhandle = execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\setskin\change_skin.sqf"";";
		};
	...
	class JAS_CUP_B_AH1Z_USMC : JAS_CUP_B_AH1Z_BASE
	{
		...
		class UserActions
		{
			...
			class FindRadarTGT
			{
				...
				statement = "[this] execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\SEAD\harmChopper.sqf""; ";
				onlyforplayer = "False";
			};
			class ClearRadarTGT
			{
			...
			class SearchRDRTGT
			{
				...
				statement = "[this] execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\SEAD\Search_RDRTGTChopper.sqf""; ";
				onlyforplayer = "False";
			};
		};
		class eventhandlers
		{
			Init = "[_this select 0] execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\init\initSEAD.sqf"";";
			fired = "fcs = [_this] execVM ""\ARMA3_CUP_Enhancement_AH1Z\sqs\init\Fire.sqf"";";
		};
	};
