private ["_logic","_units","_activated","_hp1","_hp2","_hp3","_hp4","_hp5","_hp6","_hp7","_hp8"];
...
if (_activated) then {
		...
		{
			_plane = vehicle _x;
			if (_plane iskindof "JAS_O_Plane_CAS_02_F") then
			{
				[_plane,_hp1,_hp2,_hp3,_hp4,_hp5,_hp6,_hp7,_hp8] spawn JAS_fnc_yak_loadout_set;
			}
			else 
			{
				hint "module is must sync with Yak-131!";
			};
		} foreach _units;
