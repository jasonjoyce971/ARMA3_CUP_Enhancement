...
Switch (_skin) Do
{
	case 0: // RUS
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\ru_dark_001_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\ru_dark_002_co.paa"];			
	};
};
