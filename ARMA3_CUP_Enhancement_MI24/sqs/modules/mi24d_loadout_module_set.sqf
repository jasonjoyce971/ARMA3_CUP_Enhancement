...
_AT2count = {_x == "JAS_CUP_1Rnd_AT2_DummyRack_M"} count magazines _plane;
...
if (_AT2count >= 1) then 
{
	_plane addweaponturret ["JAS_CUP_Vmlauncher_AT2_veh",[0]];
	_counter = 0;

	while {_counter < _AT2count} do
	{
		_counter = _counter + 1;
		_plane addmagazineturret ["ProxyCUP_3M11_Falanga_AT2_proxy",[0]];
		_plane addmagazineturret ["ProxyCUP_3M11_Falanga_AT2_proxy",[0]];
	};
};
...
Switch (_skin) Do
{
	case 0: // CDF
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\mi35_001_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\mi35_002_co.paa"];			
	};
	case 1: // TKA
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\mi35_001_ind_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\mi35_002_ind_co.paa"];
	};
	case 2: // UN
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\unitednations_white_001_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\unitednations_white_002_co.paa"];
	};
	case 3: // AAF
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\aaf_001_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\aaf_002_co.paa"];
	};
	case 4: // ION
	{
		_plane setobjecttextureglobal[0, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\ion_001_co.paa"]; 
		_plane setobjecttextureglobal[1, "\cup\airvehicles\cup_airvehicles_mi24\data\textures\ion_002_co.paa"];
	};
};
