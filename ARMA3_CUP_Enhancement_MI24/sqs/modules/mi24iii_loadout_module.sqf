...
if (_activated) then {
		...
		{
			_plane = vehicle _x;
			if (_plane iskindof "JAS_CUP_MI35_TOH_Base") then
			{
				[_plane,_hp1,_hp2,_hp3,_hp4,_hp5,_hp6] spawn JAS_fnc_mi24iii_loadout_set;
			}
			else 
			{
				hint "module must sync with Mi-24III!";
			};
		} foreach _units;
