...
else 
{
	Switch (_preset) do
	{
		...
		case 1:
		{
			if (isNil {profileNamespace getVariable "24D_Custom_slot1"}) then
			{
		...
		case 2:
		{
			if (isNil {profileNamespace getVariable "24D_Custom_slot2"}) then
			{
		...
		case 3:
		{
			if (isNil {profileNamespace getVariable "24D_Custom_slot3"}) then
			{
