...
_plane removeMagazinesturret ["CUP_750Rnd_TE1_30mm_GSh302K_HE_M",[-1]];
...
_plane removeweaponturret ["JAS_CUP_Vmlauncher_AT6_veh",[0]];
_plane removeweaponturret ["CUP_Vacannon_GSh302K_veh",[-1]];
...
_plane addweaponturret ["CUP_Vacannon_GSh302K_veh",[-1]];
_plane addmagazineturret ["CUP_750Rnd_TE1_30mm_GSh302K_HE_M",[-1]];
...
else 
{
	Switch (_preset) do
	{
		...
		case 1:
		{
			if (isNil {profileNamespace getVariable "24P_Custom_slot1"}) then
			{
			...
			else
			{
				...
				_loadcustom1 = ["custom1"]execVM "ARMA3_CUP_Enhancement_MI24\sqs\Loadout\24D_Custom_Apply.sqf";
			};		
		};

		case 2:
		{
			if (isNil {profileNamespace getVariable "24P_Custom_slot2"}) then
			{
			...
			{
				titleText ["Found custom loadout data. Loading..", "PLAIN DOWN",0.5];
				_loadcustom1 = ["custom2"]execVM "ARMA3_CUP_Enhancement_MI24\sqs\Loadout\24D_Custom_Apply.sqf";
			};			
		};

		case 3:
		{
			if (isNil {profileNamespace getVariable "24P_Custom_slot3"}) then
			{
			...
			{
				titleText ["Found custom loadout data. Loading..", "PLAIN DOWN",0.5];
				_loadcustom1 = ["custom3"]execVM "ARMA3_CUP_Enhancement_MI24\sqs\Loadout\24D_Custom_Apply.sqf";
			};	
		};
	};
};
